 ...
 * defined in a TSV file. Useful for testing all tools after code changes
 * and warming the SQLite mmap page cache.
 *
 * Usage:
 ...
 *   1. content[0].text always present and non-empty
 ...
 *   4. content[0].text is not raw JSON (compact summaries expected)
 */
...
// Tools whose content text should be a compact human-readable summary, not raw JSON.
const COMPACT_CONTENT_TOOLS = new Set(["search", "browse", "resolve", "expand_keys", "search_prefix"]);
